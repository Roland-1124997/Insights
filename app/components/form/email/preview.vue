	...
	<div>
		<header class="flex-shrink-0">
			<div class="z-40 flex items-center gap-2 -mt-3">
				...
				<button @click="toggleCollapse" class="flex items-center justify-center w-40 gap-2 px-3 py-[0.40rem] text-sm font-medium text-gray-700 transition-colors duration-200 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400" :aria-label="collapsed ? 'Klap bericht uit' : 'Klap bericht in'" :aria-expanded="!collapsed">
